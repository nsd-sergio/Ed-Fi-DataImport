...
{
    [TestFixture]
    public class SwaggerMetadataProcessorV3Tests
    {
        ...
        {
            var sampleMetadataFolder = $"SampleMetadata-v7.1.1{Path.DirectorySeparatorChar}";
        ...
        [Test]
        public void ShouldHandleSwaggerVersion3()
        {
            var sut = new SwaggerMetadataProcessorV3();
        ...
        public async Task ShouldFindResourcesAndDescriptors()
        {
            ...
            result.Count.ShouldBe(143);
            result.All(x => x.ApiSection == ApiSection.Resources).ShouldBe(true);
            result.All(x => x.SwaggerVersion == "3.0.1").ShouldBe(true);
